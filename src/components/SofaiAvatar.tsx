...
// occhiali verde acqua: è il complementare dell'arancione, quindi stacca dai
// capelli biondi senza portare in scena un colore fuori tavolozza
const FRAME = '#2dd4bf';
const LENS = 'rgba(45,212,191,0.14)';
const TIE = '#fb7185';
...
function Eyes({ mood }: { mood: SofiaMood }) {
  switch (mood) {
    case 'wow':
      return (
        <>
          <circle cx={44} cy={62} r={5.5} fill="#33241a" />
          <circle cx={76} cy={62} r={5.5} fill="#33241a" />
    ...
    case 'teasing': // occhiolino
      return (
        <>
          <circle cx={44} cy={62} r={4.5} fill="#33241a" />
          <circle cx={45.5} cy={60.5} r={1.6} fill="#fff" />
          <path d="M70 62 Q76 65 82 62" stroke="#33241a" strokeWidth={3} fill="none" strokeLinecap="round" />
        </>
      );
    case 'thinking': // occhi in su
      return (
        <>
          <circle cx={44} cy={59} r={4.5} fill="#33241a" />
          <circle cx={76} cy={59} r={4.5} fill="#33241a" />
    ...
    case 'sad':
      return (
        <>
          <circle cx={44} cy={63} r={4.5} fill="#33241a" />
          <circle cx={76} cy={63} r={4.5} fill="#33241a" />
    ...
    default: // happy
      return (
        <>
          <circle cx={44} cy={62} r={4.8} fill="#33241a" />
          <circle cx={76} cy={62} r={4.8} fill="#33241a" />
...
function Mouth({ mood }: { mood: SofiaMood }) {
  switch (mood) {
    case 'wow':
      return <ellipse cx={60} cy={84} rx={7} ry={9} fill="#7f1d1d" stroke="#33241a" strokeWidth={2} />;
    case 'teasing':
      return <path d="M50 84 Q60 92 72 82" stroke="#33241a" strokeWidth={3.5} fill="none" strokeLinecap="round" />;
    case 'thinking':
      return <path d="M53 86 Q60 84 67 86" stroke="#33241a" strokeWidth={3.5} fill="none" strokeLinecap="round" />;
    case 'sad':
      return <path d="M50 88 Q60 80 70 88" stroke="#33241a" strokeWidth={3.5} fill="none" strokeLinecap="round" />;
    default:
      return <path d="M48 82 Q60 94 72 82" stroke="#33241a" strokeWidth={3.5} fill="none" strokeLinecap="round" />;
  }
}
...
export function SofaiAvatar({ mood = 'happy', size = 72 }: { mood?: SofiaMood; size?: number }) {
  return (
    <svg viewBox="0 0 120 120" width={size} height={size} aria-label="SofAI">
      ...
      <circle cx={20} cy={54} r={4} fill={TIE} />
      <circle cx={100} cy={54} r={4} fill={TIE} />
      {/* chioma dietro */}
      ...
      {/* occhiali tondi */}
      <circle cx={44} cy={62} r={12.5} fill={LENS} stroke={FRAME} strokeWidth={3.5} />
      <circle cx={76} cy={62} r={12.5} fill={LENS} stroke={FRAME} strokeWidth={3.5} />
